...
#
# Usage:
#   ./virric/domains/product-marketing/scripts/add_proposition_pain_reliever.sh --proposition <file> --reliever "..." [--mapped-pains "JTBD-PAIN-0001-PER-0001,JTBD-PAIN-0002-PER-0001"]
...
usage() {
  cat <<'EOF'
Usage:
  ./virric/domains/product-marketing/scripts/add_proposition_pain_reliever.sh --proposition <file> --reliever "..." [--mapped-pains "..."]
EOF
}
