...
Usage:
  ./virric/domains/product-marketing/scripts/validate_persona.sh <persona_file>
  ./virric/domains/product-marketing/scripts/validate_persona.sh --all
  ./virric/domains/product-marketing/scripts/validate_persona.sh --strict <persona_file>
  ./virric/domains/product-marketing/scripts/validate_persona.sh --all --strict
