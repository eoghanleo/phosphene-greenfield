...
#
# Usage:
#   ./virric/domains/product-marketing/scripts/remove_proposition_target_persona.sh --proposition <file> --persona PER-0001
...
print(f"Removed target persona {item} ({removed} occurrence(s)) -> {p}")
PY
