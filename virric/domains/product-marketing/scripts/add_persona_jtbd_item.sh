...
#
# Usage:
#   ./virric/domains/product-marketing/scripts/add_persona_jtbd_item.sh \
...
usage() {
  cat <<'EOF'
Usage:
  ./virric/domains/product-marketing/scripts/add_persona_jtbd_item.sh --persona <file> --type JOB|PAIN|GAIN --text "..." --importance 1..5
EOF
}
