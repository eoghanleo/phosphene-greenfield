...
#
# Usage:
#   ./virric/domains/product-marketing/scripts/add_persona_evidence_link.sh --persona <file> --id E-0001
#   ./virric/domains/product-marketing/scripts/add_persona_evidence_link.sh --persona <file> --id CPE-0001
#   ./virric/domains/product-marketing/scripts/add_persona_evidence_link.sh --persona <file> --id RA-001
...
usage() {
  cat <<'EOF'
Usage:
  ./virric/domains/product-marketing/scripts/add_persona_evidence_link.sh --persona <file> --id <stable-id>
EOF
}
