...
#
# Usage:
#   ./virric/domains/product-marketing/scripts/update_proposition_capability.sh --proposition <file> --capability-id CAP-0001-PROP-0001 [--type feature|function|standard|experience] [--capability "..."]
