...
#
# Usage:
#   ./virric/domains/product-marketing/scripts/overwrite_proposition_notes.sh --proposition <file> --notes-file <md_file>
...
TMP_OUT="$(mktemp)"
set +e
PROP_PATH="$PROP" OUT_PATH="$TMP_OUT" NEW_NOTES="$CONTENT" python3 - <<'PY'
import os, sys
