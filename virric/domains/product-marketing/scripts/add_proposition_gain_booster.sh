...
#
# Usage:
#   ./virric/domains/product-marketing/scripts/add_proposition_gain_booster.sh --proposition <file> --booster "..." [--mapped-gains "JTBD-GAIN-0001-PER-0001,JTBD-GAIN-0002-PER-0001"]
...
usage() {
  cat <<'EOF'
Usage:
  ./virric/domains/product-marketing/scripts/add_proposition_gain_booster.sh --proposition <file> --booster "..." [--mapped-gains "..."]
EOF
}
