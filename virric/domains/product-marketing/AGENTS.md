...
- Only write `DONE.json` (at `virric/domains/product-marketing/DONE.json`) after you can credibly claim you’ve mined the value space (see the domain skill’s coverage gates/checklist).
