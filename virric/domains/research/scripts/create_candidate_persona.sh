...
#
# Usage:
#   ./virric/domains/research/scripts/create_candidate_persona.sh --bundle <bundle_dir> --name "Idle Ingrid" [--segment SEG-0001]
...
DATE="$(date +%F)"
TEMPLATE="$ROOT/virric/domains/research/templates/candidate-persona.md"
