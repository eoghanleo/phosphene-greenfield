...
- Artifacts for this domain live in canonical `output/` and `signals/` areas within the repo.
  - Control scripts live under: `.codex/skills/phosphene/beryl/research/modulator/scripts/`
...
- Create a new RA bundle folder (allocates RA IDs if needed):
  - `./.codex/skills/phosphene/beryl/research/modulator/scripts/create_research_assessment_bundle.sh ...`
