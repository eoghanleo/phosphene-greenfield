...
#   ./phosphene/domains/research/tools/create_research_assessment_bundle.sh --title "..." [--id RA-001] [--owner ""] [--priority Medium]
...
echo "  ./phosphene/domains/research/tools/create_candidate_persona.sh --bundle \"$BUNDLE_DIR\" --name \"...\" --segment SEG-0001" >> "$BUNDLE_DIR/60-candidate-personas/README.md"

echo "Created RA bundle: $BUNDLE_DIR"
echo "Next:"
echo "  - validate: ./phosphene/domains/research/tools/validate_research_assessment_bundle.sh \"$BUNDLE_DIR\""
echo "  - assemble: ./phosphene/domains/research/tools/assemble_research_assessment_bundle.sh \"$BUNDLE_DIR\""
