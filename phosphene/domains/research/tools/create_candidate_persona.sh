...
#
# Usage:
#   ./phosphene/domains/research/tools/create_candidate_persona.sh --bundle <bundle_dir> --name "Idle Ingrid" [--segment SEG-0001]
...
usage() {
  cat <<'EOF'
Usage:
  ./phosphene/domains/research/tools/create_candidate_persona.sh --bundle <bundle_dir> --name "..." [--segment SEG-0001]
EOF
}
