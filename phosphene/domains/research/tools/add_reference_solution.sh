...
#
# Usage:
#   ./phosphene/domains/research/tools/add_reference_solution.sh --bundle <bundle_dir> --name "..." [--type Market] [--pointer "https://..."]
...
usage() {
  cat <<'EOF'
Usage:
  ./phosphene/domains/research/tools/add_reference_solution.sh --bundle <bundle_dir> --name "..." [--type Market|Academic] [--pointer "https://..."]
EOF
}
