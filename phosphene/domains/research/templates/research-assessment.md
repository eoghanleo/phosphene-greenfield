...
- `phosphene/domains/research/templates/research-assessment-bundle/`

Use the bundle scripts (run from repo root):
- `./phosphene/domains/research/scripts/create_research_assessment_bundle.sh`
- `./phosphene/domains/research/scripts/validate_research_assessment_bundle.sh`
- `./phosphene/domains/research/scripts/assemble_research_assessment_bundle.sh`
