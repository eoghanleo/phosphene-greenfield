...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/update_proposition_formal_pitch.sh --proposition <file> --pitch-file <md_file>
#   ./phosphene/domains/product-marketing/tools/update_proposition_formal_pitch.sh --proposition <file> --pitch "<single line>"
...
if ! "$ROOT/phosphene/domains/product-marketing/tools/validate_proposition.sh" --strict "$TMP_OUT" >/dev/null; then
  val_rc=$?
  rm -f "$TMP_OUT"
  exit $val_rc
fi
