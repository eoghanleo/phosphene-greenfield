...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/add_persona_evidence_link.sh --persona <file> --id E-0001
#   ./phosphene/domains/product-marketing/tools/add_persona_evidence_link.sh --persona <file> --id CPE-0001
#   ./phosphene/domains/product-marketing/tools/add_persona_evidence_link.sh --persona <file> --id RA-001
...
usage() {
  cat <<'EOF'
Usage:
  ./phosphene/domains/product-marketing/tools/add_persona_evidence_link.sh --persona <file> --id <stable-id>
EOF
}
...
if ! "$ROOT/phosphene/domains/product-marketing/tools/validate_persona.sh" "$TMP_OUT" >/dev/null; then
  rc=$?
  rm -f "$TMP_OUT" || true
  exit $rc
fi
...
"$ROOT/phosphene/domains/product-marketing/tools/validate_persona.sh" "$PERSONA" >/dev/null
