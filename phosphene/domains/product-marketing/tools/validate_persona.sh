...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/validate_persona.sh <persona_file>
...
Usage:
  ./phosphene/domains/product-marketing/tools/validate_persona.sh <persona_file>
  ./phosphene/domains/product-marketing/tools/validate_persona.sh --all
  ./phosphene/domains/product-marketing/tools/validate_persona.sh --strict <persona_file>
  ./phosphene/domains/product-marketing/tools/validate_persona.sh --all --strict
