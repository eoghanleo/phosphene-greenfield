...
#   ./phosphene/domains/product-marketing/tools/create_value_proposition_design_bundle.sh --title "..." [--id VPD-001] [--owner ""] [--priority Medium]
...
Create persona files here (PER-*.md). Recommended:
  ...
  ./phosphene/domains/product-marketing/tools/create_new_persona.sh \\
    --title "..." \\
    --vpd "${ID}" \\
    --dependencies "RA-001" \\
...
Create proposition files here (PROP-*.md). Recommended:
  ...
  ./phosphene/domains/product-marketing/tools/create_new_proposition.sh \\
    --title "..." \\
    --vpd "${ID}" \\
...
echo "Next:"
echo "  - create personas: ./phosphene/domains/product-marketing/tools/create_new_persona.sh --vpd \"${ID}\" --output-dir \"$BUNDLE_DIR/10-personas\" --dependencies \"...\" --title \"...\""
echo "  - create propositions: ./phosphene/domains/product-marketing/tools/create_new_proposition.sh --vpd \"${ID}\" --output-dir \"$BUNDLE_DIR/20-propositions\" --dependencies \"...\" --title \"...\""
