...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/product-marketing-domain-done-score.sh
#   ./phosphene/domains/product-marketing/tools/product-marketing-domain-done-score.sh --min-score 80
#   ./phosphene/domains/product-marketing/tools/product-marketing-domain-done-score.sh --docs-root phosphene/domains/product-marketing/output
#
# Exit codes:
#   0 = score >= min-score
#   1 = score < min-score
...
usage() {
  cat <<'EOF'
Usage:
  ./phosphene/domains/product-marketing/tools/product-marketing-domain-done-score.sh [--docs-root <dir>] [--input-research-root <dir>] [--min-score <0..100>] [--quiet]
...
if [[ "$QUIET" -ne 1 ]]; then
  ...
  echo "  - output:   ${corpus_words} cleaned words (agent-written; IDs/tools/tags excluded)"
  echo ""
