...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/validate_proposition.sh <proposition_file>
...
Usage:
  ./phosphene/domains/product-marketing/tools/validate_proposition.sh <proposition_file>
  ./phosphene/domains/product-marketing/tools/validate_proposition.sh --all
  ./phosphene/domains/product-marketing/tools/validate_proposition.sh --strict <proposition_file>
  ./phosphene/domains/product-marketing/tools/validate_proposition.sh --all --strict
