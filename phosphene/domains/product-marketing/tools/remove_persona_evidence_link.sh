...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/remove_persona_evidence_link.sh --persona <file> --id E-0001
...
usage() {
  cat <<'EOF'
Usage:
  ./phosphene/domains/product-marketing/tools/remove_persona_evidence_link.sh --persona <file> --id <stable-id>
EOF
}
