...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/update_persona_summary.sh --persona <file> --summary-file <md_file>
#   ./phosphene/domains/product-marketing/tools/update_persona_summary.sh --persona <file> --summary "<single line>"
...
if ! "$ROOT/phosphene/domains/product-marketing/tools/validate_persona.sh" --strict "$TMP_OUT" >/dev/null; then
  val_rc=$?
  rm -f "$TMP_OUT"
  exit $val_rc
fi
