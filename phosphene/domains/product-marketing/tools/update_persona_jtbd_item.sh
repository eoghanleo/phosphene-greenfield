...
#
# Usage:
#   ./phosphene/domains/product-marketing/tools/update_persona_jtbd_item.sh --persona <file> --jtbd-id JTBD-PAIN-0001-PER-0003 [--text "..."] [--importance 1..5]
...
usage() {
  cat <<'EOF'
Usage:
  ./phosphene/domains/product-marketing/tools/update_persona_jtbd_item.sh --persona <file> --jtbd-id JTBD-<TYPE>-####-PER-#### [--text "..."] [--importance 1..5]
EOF
}
