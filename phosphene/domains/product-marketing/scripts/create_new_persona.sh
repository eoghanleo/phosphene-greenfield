...
TEMPLATE="$ROOT/phosphene/domains/product-marketing/templates/value-proposition-design-bundle/persona.md"
...
set +e
"$ROOT/phosphene/domains/product-marketing/scripts/validate_persona.sh" --strict "$TMP_EDIT" >/dev/null
rc=$?
set -e
if [[ $rc -ne 0 ]]; then
