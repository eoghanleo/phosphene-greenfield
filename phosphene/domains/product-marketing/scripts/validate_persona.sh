...
#
# Usage:
#   ./phosphene/domains/product-marketing/scripts/validate_persona.sh <persona_file>
...
Usage:
  ./phosphene/domains/product-marketing/scripts/validate_persona.sh <persona_file>
  ./phosphene/domains/product-marketing/scripts/validate_persona.sh --all
  ./phosphene/domains/product-marketing/scripts/validate_persona.sh --strict <persona_file>
  ./phosphene/domains/product-marketing/scripts/validate_persona.sh --all --strict
...
if [[ "${1:-}" == "--all" ]]; then
  ...
  dir="$ROOT/phosphene/domains/product-marketing/docs/personas"
