...
- Build: `./phosphene/domains/research/scripts/research_id_registry.sh build`
- Validate: `./phosphene/domains/research/scripts/research_id_registry.sh validate`
- Allocate: `./phosphene/domains/research/scripts/research_id_registry.sh next --type ra|pitch|evidence|refsol|segment|cpe|persona`
...
- Create pitches / add evidence / add reference solutions:
  - `./phosphene/domains/research/scripts/create_product_pitch.sh <bundle_dir>`
  - `./phosphene/domains/research/scripts/add_evidence_record.sh <bundle_dir>`
  - `./phosphene/domains/research/scripts/add_reference_solution.sh <bundle_dir>`
