...
- Validate a persona:
  - `./phosphene/domains/product-marketing/scripts/validate_persona.sh phosphene/domains/product-marketing/output/value-proposition-designs/VPD-001-.../10-personas/PER-0001.md`
- Validate a proposition:
  - `./phosphene/domains/product-marketing/scripts/validate_proposition.sh phosphene/domains/product-marketing/output/value-proposition-designs/VPD-001-.../20-propositions/PROP-0001.md`
...
- Update snapshot summary:
  - `./phosphene/domains/product-marketing/scripts/update_persona_summary.sh --persona phosphene/domains/product-marketing/output/value-proposition-designs/VPD-001-.../10-personas/PER-0001-*.md --summary-file /path/to/summary.md`
...
- Add/remove supporting IDs (EvidenceIDs/CPE IDs/other DocumentIDs):
  - `./phosphene/domains/product-marketing/scripts/add_persona_evidence_link.sh --persona ... --id E-0001`
  - `./phosphene/domains/product-marketing/scripts/remove_persona_evidence_link.sh --persona ... --id E-0001`
- Add/remove related links:
  - `./phosphene/domains/product-marketing/scripts/add_persona_related_link.sh --persona ... --link "https://example.com"`
  - `./phosphene/domains/product-marketing/scripts/remove_persona_related_link.sh --persona ... --link "https://example.com"`
- Notes:
  - `./phosphene/domains/product-marketing/scripts/add_persona_note.sh --persona ... --note "..." `
  - `./phosphene/domains/product-marketing/scripts/overwrite_persona_notes.sh --persona ... --notes-file /path/to/notes.md`
...
- Target personas / related segments:
  - `./phosphene/domains/product-marketing/scripts/add_proposition_target_persona.sh --proposition ... --persona PER-0001`
  - `./phosphene/domains/product-marketing/scripts/remove_proposition_target_persona.sh --proposition ... --persona PER-0001`
  - `./phosphene/domains/product-marketing/scripts/add_proposition_related_segment.sh --proposition ... --segment SEG-0001`
  - `./phosphene/domains/product-marketing/scripts/remove_proposition_related_segment.sh --proposition ... --segment SEG-0001`
- Gain boosters / pain relievers:
  - `./phosphene/domains/product-marketing/scripts/add_proposition_gain_booster.sh --proposition ... --booster "..." --mapped-gains "JTBD-GAIN-0001-PER-0001"`
  - `./phosphene/domains/product-marketing/scripts/update_proposition_gain_booster.sh --proposition ... --booster-id BOOST-0001-PROP-0001 --mapped-gains "..."`
  - `./phosphene/domains/product-marketing/scripts/add_proposition_pain_reliever.sh --proposition ... --reliever "..." --mapped-pains "JTBD-PAIN-0001-PER-0001"`
  - `./phosphene/domains/product-marketing/scripts/update_proposition_pain_reliever.sh --proposition ... --reliever-id REL-0001-PROP-0001 --mapped-pains "..."`
- Capabilities:
  - `./phosphene/domains/product-marketing/scripts/add_proposition_capability.sh --proposition ... --type feature --capability "..."`
  - `./phosphene/domains/product-marketing/scripts/update_proposition_capability.sh --proposition ... --capability-id CAP-0001-PROP-0001 --type experience --capability "..."`
- Notes:
  - `./phosphene/domains/product-marketing/scripts/add_proposition_note.sh --proposition ... --note "..." `
  - `./phosphene/domains/product-marketing/scripts/overwrite_proposition_notes.sh --proposition ... --notes-file /path/to/notes.md`
